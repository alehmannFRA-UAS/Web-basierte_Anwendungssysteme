...
public class ConversationServiceImpl implements ConversationService {
	...
	@Override
	public boolean deleteConversationBetween(ConversationUser userFrom, ConversationUser userTo) {
		...
		if((userTo.getConversations().remove(from) != null) && userFrom.getConversations().remove(to) != null) {
