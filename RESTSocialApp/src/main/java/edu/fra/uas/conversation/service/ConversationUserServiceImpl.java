...
public class ConversationUserServiceImpl implements ConversationUserService {
	...
	@Override
	public boolean deleteConversationFromTo(String from, String to) {
		log.debug("delete conversation between " + from + " and " + to);
		ConversationUser userFrom = conversationUserRepository.findByNickname(from).orElse(null);
		ConversationUser userTo = conversationUserRepository.findByNickname(to).orElse(null);
		return conversationService.deleteConversationBetween(userFrom, userTo);
	}
	...
	@Override
	public void createConversationsUser(UserCreate userCreate) {
		log.debug("createConversationUser " + userCreate.getNickname());
		ConversationUser conversationUser = new ConversationUser();
		conversationUser.setNickname(userCreate.getNickname());
